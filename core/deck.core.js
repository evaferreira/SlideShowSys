...
(function($, undefined) {
  ...
  */
  ...
  $window.bind('load.deck', function() {
	...
	var duration = document.getElementById('timer-line').getAttribute('data-duration');
	if(duration > 0) {
		var timer = document.createElement('div');

		timer.id = 'timer';
		timer.setAttribute('style', 'transition-duration: ' + this.duration * 60 + 's;');
		document.getElementById('timer-line').appendChild(timer);
